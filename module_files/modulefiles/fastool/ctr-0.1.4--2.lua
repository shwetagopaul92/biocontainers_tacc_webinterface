local help_message = [[
This is a module file for the container quay.io/biocontainers/fastool:0.1.4--2, which exposes the
following programs:
...
set_shell_function("fastool",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/fastool/fastool-0.1.4--2.simg fastool $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/fastool/fastool-0.1.4--2.simg fastool $*')
