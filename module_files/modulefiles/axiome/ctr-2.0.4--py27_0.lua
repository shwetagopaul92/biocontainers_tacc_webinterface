local help_message = [[
This is a module file for the container quay.io/biocontainers/axiome:2.0.4--py27_0, which exposes the
following programs:
...
set_shell_function("axiome",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/axiome/axiome-2.0.4--py27_0.simg axiome $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/axiome/axiome-2.0.4--py27_0.simg axiome $*')
