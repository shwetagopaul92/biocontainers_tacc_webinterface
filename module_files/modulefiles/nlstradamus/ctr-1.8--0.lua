local help_message = [[
This is a module file for the container quay.io/biocontainers/nlstradamus:1.8--0, which exposes the
following programs:
...
set_shell_function("NLStradamus",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/nlstradamus/nlstradamus-1.8--0.simg NLStradamus $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/nlstradamus/nlstradamus-1.8--0.simg NLStradamus $*')
