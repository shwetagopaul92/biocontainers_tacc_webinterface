local help_message = [[
This is a module file for the container quay.io/biocontainers/plant_tribes_gene_family_integrator:1.0.0--pl5.22.0_0, which exposes the
following programs:
...
set_shell_function("GeneFamilyIntegrator",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/plant_tribes_gene_family_integrator/plant_tribes_gene_family_integrator-1.0.0--pl5.22.0_0.simg GeneFamilyIntegrator $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/plant_tribes_gene_family_integrator/plant_tribes_gene_family_integrator-1.0.0--pl5.22.0_0.simg GeneFamilyIntegrator $*')
set_shell_function("perl5.22.0",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/plant_tribes_gene_family_integrator/plant_tribes_gene_family_integrator-1.0.0--pl5.22.0_0.simg perl5.22.0 $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/plant_tribes_gene_family_integrator/plant_tribes_gene_family_integrator-1.0.0--pl5.22.0_0.simg perl5.22.0 $*')
