local help_message = [[
This is a module file for the container quay.io/biocontainers/preseq:2.0.3--gsl2.2_1, which exposes the
following programs:
...
whatis("Name: preseq")
whatis("Version: ctr-2.0.3--gsl2.2_1")
...
set_shell_function("bam2mr",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/preseq/preseq-2.0.3--gsl2.2_1.simg bam2mr $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/preseq/preseq-2.0.3--gsl2.2_1.simg bam2mr $*')
set_shell_function("preseq",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/preseq/preseq-2.0.3--gsl2.2_1.simg preseq $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/preseq/preseq-2.0.3--gsl2.2_1.simg preseq $*')
