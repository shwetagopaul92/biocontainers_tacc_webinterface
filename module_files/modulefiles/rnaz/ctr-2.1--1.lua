local help_message = [[
This is a module file for the container quay.io/biocontainers/rnaz:2.1--1, which exposes the
following programs:
...
set_shell_function("RNAz",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/rnaz/rnaz-2.1--1.simg RNAz $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/rnaz/rnaz-2.1--1.simg RNAz $*')
set_shell_function("perl5.22.0",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/rnaz/rnaz-2.1--1.simg perl5.22.0 $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/rnaz/rnaz-2.1--1.simg perl5.22.0 $*')
