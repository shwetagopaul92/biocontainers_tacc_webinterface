local help_message = [[
This is a module file for the container quay.io/biocontainers/mlrho:2.9--hd1ccf6d_1, which exposes the
following programs:
...
whatis("Name: mlrho")
whatis("Version: ctr-2.9--hd1ccf6d_1")
...
set_shell_function("mlRho",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/mlrho/mlrho-2.9--hd1ccf6d_1.simg mlRho $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/mlrho/mlrho-2.9--hd1ccf6d_1.simg mlRho $*')
