local help_message = [[
This is a module file for the container quay.io/biocontainers/lighter:1.1.1--he941832_3, which exposes the
following programs:
...
whatis("Name: lighter")
whatis("Version: ctr-1.1.1--he941832_3")
...
set_shell_function("lighter",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/lighter/lighter-1.1.1--he941832_3.simg lighter $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/lighter/lighter-1.1.1--he941832_3.simg lighter $*')
