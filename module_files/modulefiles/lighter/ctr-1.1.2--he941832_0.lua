local help_message = [[
This is a module file for the container quay.io/biocontainers/lighter:1.1.2--he941832_0, which exposes the
following programs:
...
whatis("Name: lighter")
whatis("Version: ctr-1.1.2--he941832_0")
...
set_shell_function("lighter",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/lighter/lighter-1.1.2--he941832_0.simg lighter $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/lighter/lighter-1.1.2--he941832_0.simg lighter $*')
