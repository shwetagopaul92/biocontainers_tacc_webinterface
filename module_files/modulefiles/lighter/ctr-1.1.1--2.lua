local help_message = [[
This is a module file for the container quay.io/biocontainers/lighter:1.1.1--2, which exposes the
following programs:
...
set_shell_function("lighter",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/lighter/lighter-1.1.1--2.simg lighter $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/lighter/lighter-1.1.1--2.simg lighter $*')
