local help_message = [[
This is a module file for the container quay.io/biocontainers/ocrad:0.21--0, which exposes the
following programs:
...
set_shell_function("ocrad",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/ocrad/ocrad-0.21--0.simg ocrad $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/ocrad/ocrad-0.21--0.simg ocrad $*')
