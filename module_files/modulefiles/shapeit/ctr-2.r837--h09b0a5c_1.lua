local help_message = [[
This is a module file for the container quay.io/biocontainers/shapeit:2.r837--h09b0a5c_1, which exposes the
following programs:
...
whatis("Name: shapeit")
whatis("Version: ctr-2.r837--h09b0a5c_1")
...
set_shell_function("shapeit",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/shapeit/shapeit-2.r837--h09b0a5c_1.simg shapeit $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/shapeit/shapeit-2.r837--h09b0a5c_1.simg shapeit $*')
