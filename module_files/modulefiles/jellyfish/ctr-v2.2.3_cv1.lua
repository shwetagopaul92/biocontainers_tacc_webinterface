local help_message = [[
This is a module file for the container biocontainers/jellyfish:v2.2.3_cv1, which exposes the
following programs:
...
set_shell_function("jellyfish",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/jellyfish/jellyfish-v2.2.3_cv1.simg jellyfish $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/jellyfish/jellyfish-v2.2.3_cv1.simg jellyfish $*')
