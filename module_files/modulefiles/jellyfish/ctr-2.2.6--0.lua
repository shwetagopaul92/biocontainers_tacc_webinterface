local help_message = [[
This is a module file for the container quay.io/biocontainers/jellyfish:2.2.6--0, which exposes the
following programs:
...
set_shell_function("jellyfish",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/jellyfish/jellyfish-2.2.6--0.simg jellyfish $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/jellyfish/jellyfish-2.2.6--0.simg jellyfish $*')
