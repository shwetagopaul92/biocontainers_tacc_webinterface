local help_message = [[
This is a module file for the container quay.io/biocontainers/real:1.0--0, which exposes the
following programs:
...
set_shell_function("real",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/real/real-1.0--0.simg real $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/real/real-1.0--0.simg real $*')
