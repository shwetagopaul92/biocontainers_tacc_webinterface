local help_message = [[
This is a module file for the container quay.io/biocontainers/flash:1.2.11--1, which exposes the
following programs:
...
set_shell_function("flash",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/flash/flash-1.2.11--1.simg flash $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/flash/flash-1.2.11--1.simg flash $*')
