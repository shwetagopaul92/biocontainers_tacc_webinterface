local help_message = [[
This is a module file for the container quay.io/biocontainers/bats:0.4.0--1, which exposes the
following programs:
...
set_shell_function("bats",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/bats/bats-0.4.0--1.simg bats $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/bats/bats-0.4.0--1.simg bats $*')
