local help_message = [[
This is a module file for the container quay.io/biocontainers/cutadapt:1.12--py27_0, which exposes the
following programs:
...
whatis("Version: ctr-1.12--py27_0")
...
set_shell_function("cutadapt",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/cutadapt/cutadapt-1.12--py27_0.simg cutadapt $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/cutadapt/cutadapt-1.12--py27_0.simg cutadapt $*')
