local help_message = [[
This is a module file for the container quay.io/biocontainers/smhasher:0.150.1--py27h470a237_1, which exposes the
following programs:
...
whatis("Version: ctr-0.150.1--py27h470a237_1")
