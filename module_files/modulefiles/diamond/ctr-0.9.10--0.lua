local help_message = [[
This is a module file for the container quay.io/biocontainers/diamond:0.9.10--0, which exposes the
following programs:
...
set_shell_function("diamond",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/diamond/diamond-0.9.10--0.simg diamond $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/diamond/diamond-0.9.10--0.simg diamond $*')
