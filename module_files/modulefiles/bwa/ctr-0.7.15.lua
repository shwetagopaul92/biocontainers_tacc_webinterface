local help_message = [[
This is a module file for the container biocontainers/bwa:0.7.15, which exposes the
following programs:
...
set_shell_function("bwa",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/bwa/bwa-0.7.15.simg bwa $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/bwa/bwa-0.7.15.simg bwa $*')
