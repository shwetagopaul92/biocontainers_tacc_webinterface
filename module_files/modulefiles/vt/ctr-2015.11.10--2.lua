local help_message = [[
This is a module file for the container quay.io/biocontainers/vt:2015.11.10--2, which exposes the
following programs:
...
whatis("Name: vt")
whatis("Version: ctr-2015.11.10--2")
...
set_shell_function("vt",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/vt/vt-2015.11.10--2.simg vt $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/vt/vt-2015.11.10--2.simg vt $*')
