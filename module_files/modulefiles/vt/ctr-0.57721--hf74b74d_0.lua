local help_message = [[
This is a module file for the container quay.io/biocontainers/vt:0.57721--hf74b74d_0, which exposes the
following programs:
...
whatis("Name: vt")
whatis("Version: ctr-0.57721--hf74b74d_0")
...
set_shell_function("vt",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/vt/vt-0.57721--hf74b74d_0.simg vt $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/vt/vt-0.57721--hf74b74d_0.simg vt $*')
