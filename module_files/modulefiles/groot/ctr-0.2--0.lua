local help_message = [[
This is a module file for the container quay.io/biocontainers/groot:0.2--0, which exposes the
following programs:
...
set_shell_function("groot",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/groot/groot-0.2--0.simg groot $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/groot/groot-0.2--0.simg groot $*')
