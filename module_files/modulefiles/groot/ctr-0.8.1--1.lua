local help_message = [[
This is a module file for the container quay.io/biocontainers/groot:0.8.1--1, which exposes the
following programs:
...
set_shell_function("groot",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/groot/groot-0.8.1--1.simg groot $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/groot/groot-0.8.1--1.simg groot $*')
