local help_message = [[
This is a module file for the container quay.io/biocontainers/samtools:1.3.1--3, which exposes the
following programs:
...
set_shell_function("samtools",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/samtools/samtools-1.3.1--3.simg samtools $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/samtools/samtools-1.3.1--3.simg samtools $*')
