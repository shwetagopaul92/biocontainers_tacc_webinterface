local help_message = [[
This is a module file for the container quay.io/biocontainers/samtools:1.8--h46bd0b3_5, which exposes the
following programs:
...
whatis("Version: ctr-1.8--h46bd0b3_5")
...
set_shell_function("samtools",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/samtools/samtools-1.8--h46bd0b3_5.simg samtools $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/samtools/samtools-1.8--h46bd0b3_5.simg samtools $*')
