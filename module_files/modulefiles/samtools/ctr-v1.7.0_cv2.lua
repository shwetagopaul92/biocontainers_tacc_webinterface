local help_message = [[
This is a module file for the container biocontainers/samtools:v1.7.0_cv2, which exposes the
following programs:
...
set_shell_function("samtools",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/samtools/samtools-v1.7.0_cv2.simg samtools $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/samtools/samtools-v1.7.0_cv2.simg samtools $*')
