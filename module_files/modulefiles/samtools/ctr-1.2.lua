local help_message = [[
This is a module file for the container biocontainers/samtools:1.2, which exposes the
following programs:
...
set_shell_function("samtools",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/samtools/samtools-1.2.simg samtools $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/samtools/samtools-1.2.simg samtools $*')
set_shell_function("varfilter.py",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/samtools/samtools-1.2.simg varfilter.py $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/samtools/samtools-1.2.simg varfilter.py $*')
