local help_message = [[
This is a module file for the container quay.io/biocontainers/samtools:1.6--h4da6232_1, which exposes the
following programs:
...
whatis("Version: ctr-1.6--h4da6232_1")
...
set_shell_function("samtools",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/samtools/samtools-1.6--h4da6232_1.simg samtools $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/samtools/samtools-1.6--h4da6232_1.simg samtools $*')
