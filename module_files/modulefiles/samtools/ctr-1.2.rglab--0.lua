local help_message = [[
This is a module file for the container quay.io/biocontainers/samtools:1.2.rglab--0, which exposes the
following programs:
...
whatis("Version: ctr-1.2.rglab--0")
...
set_shell_function("samtools",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/samtools/samtools-1.2.rglab--0.simg samtools $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/samtools/samtools-1.2.rglab--0.simg samtools $*')
