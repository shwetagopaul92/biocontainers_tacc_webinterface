local help_message = [[
This is a module file for the container quay.io/biocontainers/ascat:2.5.1--0, which exposes the
following programs:
...
set_shell_function("R",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/ascat/ascat-2.5.1--0.simg R $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/ascat/ascat-2.5.1--0.simg R $*')
set_shell_function("Rscript",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/ascat/ascat-2.5.1--0.simg Rscript $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/ascat/ascat-2.5.1--0.simg Rscript $*')
