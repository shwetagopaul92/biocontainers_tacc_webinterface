local help_message = [[
This is a module file for the container quay.io/biocontainers/gadem:1.3.1--0, which exposes the
following programs:
...
set_shell_function("gadem",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/gadem/gadem-1.3.1--0.simg gadem $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/gadem/gadem-1.3.1--0.simg gadem $*')
