local help_message = [[
This is a module file for the container quay.io/biocontainers/skewer:0.2.2--1, which exposes the
following programs:
...
set_shell_function("skewer",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/skewer/skewer-0.2.2--1.simg skewer $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/skewer/skewer-0.2.2--1.simg skewer $*')
