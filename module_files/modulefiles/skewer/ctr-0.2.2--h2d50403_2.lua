local help_message = [[
This is a module file for the container quay.io/biocontainers/skewer:0.2.2--h2d50403_2, which exposes the
following programs:
...
whatis("Name: skewer")
whatis("Version: ctr-0.2.2--h2d50403_2")
...
set_shell_function("skewer",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/skewer/skewer-0.2.2--h2d50403_2.simg skewer $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/skewer/skewer-0.2.2--h2d50403_2.simg skewer $*')
