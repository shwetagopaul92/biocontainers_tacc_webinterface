local help_message = [[
This is a module file for the container biocontainers/xtandem:10-12-01-1, which exposes the
following programs:
...
set_shell_function("tandem",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/xtandem/xtandem-10-12-01-1.simg tandem $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/xtandem/xtandem-10-12-01-1.simg tandem $*')
