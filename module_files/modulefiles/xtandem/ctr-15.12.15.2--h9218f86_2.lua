local help_message = [[
This is a module file for the container quay.io/biocontainers/xtandem:15.12.15.2--h9218f86_2, which exposes the
following programs:
...
whatis("Name: xtandem")
whatis("Version: ctr-15.12.15.2--h9218f86_2")
...
set_shell_function("xtandem",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/xtandem/xtandem-15.12.15.2--h9218f86_2.simg xtandem $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/xtandem/xtandem-15.12.15.2--h9218f86_2.simg xtandem $*')
