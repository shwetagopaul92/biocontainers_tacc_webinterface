local help_message = [[
This is a module file for the container quay.io/biocontainers/xtandem:15.12.15.2--1, which exposes the
following programs:
...
whatis("Name: xtandem")
whatis("Version: ctr-15.12.15.2--1")
...
set_shell_function("xtandem",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/xtandem/xtandem-15.12.15.2--1.simg xtandem $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/xtandem/xtandem-15.12.15.2--1.simg xtandem $*')
