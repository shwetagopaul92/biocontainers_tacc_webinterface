local help_message = [[
This is a module file for the container quay.io/biocontainers/bamtools:2.5.1--he860b03_4, which exposes the
following programs:
...
whatis("Version: ctr-2.5.1--he860b03_4")
...
set_shell_function("bamtools",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/bamtools/bamtools-2.5.1--he860b03_4.simg bamtools $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/bamtools/bamtools-2.5.1--he860b03_4.simg bamtools $*')
