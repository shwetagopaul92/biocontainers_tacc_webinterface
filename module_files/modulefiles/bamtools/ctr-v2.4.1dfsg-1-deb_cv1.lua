local help_message = [[
This is a module file for the container biocontainers/bamtools:v2.4.1dfsg-1-deb_cv1, which exposes the
following programs:
...
whatis("Version: ctr-v2.4.1dfsg-1-deb_cv1")
...
set_shell_function("bamtools",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/bamtools/bamtools-v2.4.1dfsg-1-deb_cv1.simg bamtools $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/bamtools/bamtools-v2.4.1dfsg-1-deb_cv1.simg bamtools $*')
