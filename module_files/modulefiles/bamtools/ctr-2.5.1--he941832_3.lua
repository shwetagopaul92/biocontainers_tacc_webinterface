local help_message = [[
This is a module file for the container quay.io/biocontainers/bamtools:2.5.1--he941832_3, which exposes the
following programs:
...
whatis("Version: ctr-2.5.1--he941832_3")
...
set_shell_function("bamtools",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/bamtools/bamtools-2.5.1--he941832_3.simg bamtools $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/bamtools/bamtools-2.5.1--he941832_3.simg bamtools $*')
