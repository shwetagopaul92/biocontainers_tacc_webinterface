local help_message = [[
This is a module file for the container quay.io/biocontainers/flexbar:2.5.0--0, which exposes the
following programs:
...
set_shell_function("flexbar",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/flexbar/flexbar-2.5.0--0.simg flexbar $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/flexbar/flexbar-2.5.0--0.simg flexbar $*')
