local help_message = [[
This is a module file for the container quay.io/biocontainers/heinz:2.0--0, which exposes the
following programs:
...
set_shell_function("heinz",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/heinz/heinz-2.0--0.simg heinz $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/heinz/heinz-2.0--0.simg heinz $*')
