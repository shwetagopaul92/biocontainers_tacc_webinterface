local help_message = [[
This is a module file for the container quay.io/biocontainers/vsearch:2.8.0--hfc679d8_0, which exposes the
following programs:
...
whatis("Name: vsearch")
whatis("Version: ctr-2.8.0--hfc679d8_0")
...
set_shell_function("vsearch",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/vsearch/vsearch-2.8.0--hfc679d8_0.simg vsearch $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/vsearch/vsearch-2.8.0--hfc679d8_0.simg vsearch $*')
