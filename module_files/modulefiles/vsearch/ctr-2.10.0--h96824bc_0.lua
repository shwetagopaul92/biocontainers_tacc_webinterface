local help_message = [[
This is a module file for the container quay.io/biocontainers/vsearch:2.10.0--h96824bc_0, which exposes the
following programs:
...
whatis("Name: vsearch")
whatis("Version: ctr-2.10.0--h96824bc_0")
...
set_shell_function("vsearch",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/vsearch/vsearch-2.10.0--h96824bc_0.simg vsearch $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/vsearch/vsearch-2.10.0--h96824bc_0.simg vsearch $*')
