local help_message = [[
This is a module file for the container quay.io/biocontainers/stringtie:1.3.3--py36_2, which exposes the
following programs:
...
whatis("Version: ctr-1.3.3--py36_2")
...
set_shell_function("prepDE.py",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/stringtie/stringtie-1.3.3--py36_2.simg prepDE.py $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/stringtie/stringtie-1.3.3--py36_2.simg prepDE.py $*')
set_shell_function("stringtie",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/stringtie/stringtie-1.3.3--py36_2.simg stringtie $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/stringtie/stringtie-1.3.3--py36_2.simg stringtie $*')
