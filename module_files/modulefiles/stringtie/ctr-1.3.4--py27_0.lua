local help_message = [[
This is a module file for the container quay.io/biocontainers/stringtie:1.3.4--py27_0, which exposes the
following programs:
...
whatis("Version: ctr-1.3.4--py27_0")
...
set_shell_function("prepDE.py",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/stringtie/stringtie-1.3.4--py27_0.simg prepDE.py $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/stringtie/stringtie-1.3.4--py27_0.simg prepDE.py $*')
set_shell_function("stringtie",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/stringtie/stringtie-1.3.4--py27_0.simg stringtie $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/stringtie/stringtie-1.3.4--py27_0.simg stringtie $*')
