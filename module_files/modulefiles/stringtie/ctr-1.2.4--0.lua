local help_message = [[
This is a module file for the container quay.io/biocontainers/stringtie:1.2.4--0, which exposes the
following programs:
...
set_shell_function("stringtie",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/stringtie/stringtie-1.2.4--0.simg stringtie $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/stringtie/stringtie-1.2.4--0.simg stringtie $*')
