local help_message = [[
This is a module file for the container quay.io/biocontainers/stringtie:1.3.0--1, which exposes the
following programs:
...
set_shell_function("stringtie",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/stringtie/stringtie-1.3.0--1.simg stringtie $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/stringtie/stringtie-1.3.0--1.simg stringtie $*')
