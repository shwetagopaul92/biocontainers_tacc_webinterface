local help_message = [[
This is a module file for the container quay.io/biocontainers/gffread:0.9.12--0, which exposes the
following programs:
...
set_shell_function("gffread",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/gffread/gffread-0.9.12--0.simg gffread $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/gffread/gffread-0.9.12--0.simg gffread $*')
