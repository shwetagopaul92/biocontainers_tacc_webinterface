local help_message = [[
This is a module file for the container biocontainers/gcta:v1.24.7_cv2, which exposes the
following programs:
...
whatis("Name: gcta")
whatis("Version: ctr-v1.24.7_cv2")
...
set_shell_function("gcta64",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/gcta/gcta-v1.24.7_cv2.simg gcta64 $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/gcta/gcta-v1.24.7_cv2.simg gcta64 $*')
