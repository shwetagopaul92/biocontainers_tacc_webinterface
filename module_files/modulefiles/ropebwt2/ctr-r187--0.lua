local help_message = [[
This is a module file for the container quay.io/biocontainers/ropebwt2:r187--0, which exposes the
following programs:
...
set_shell_function("ropebwt2",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/ropebwt2/ropebwt2-r187--0.simg ropebwt2 $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/ropebwt2/ropebwt2-r187--0.simg ropebwt2 $*')
