local help_message = [[
This is a module file for the container quay.io/biocontainers/vcfanno:0.2.9--0, which exposes the
following programs:
...
set_shell_function("vcfanno",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/vcfanno/vcfanno-0.2.9--0.simg vcfanno $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/vcfanno/vcfanno-0.2.9--0.simg vcfanno $*')
