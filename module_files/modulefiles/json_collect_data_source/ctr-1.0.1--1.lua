local help_message = [[
This is a module file for the container quay.io/biocontainers/json_collect_data_source:1.0.1--1, which exposes the
following programs:
...
set_shell_function("json_collect_data_source.py",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/json_collect_data_source/json_collect_data_source-1.0.1--1.simg json_collect_data_source.py $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/json_collect_data_source/json_collect_data_source-1.0.1--1.simg json_collect_data_source.py $*')
