local help_message = [[
This is a module file for the container quay.io/biocontainers/mapdia:1.0--hfc679d8_0, which exposes the
following programs:
...
set_shell_function("mapDIA",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/mapdia/mapdia-1.0--hfc679d8_0.simg mapDIA $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/mapdia/mapdia-1.0--hfc679d8_0.simg mapDIA $*')
