local help_message = [[
This is a module file for the container quay.io/biocontainers/btrim:1.0.0--hfc679d8_0, which exposes the
following programs:
...
whatis("Name: btrim")
whatis("Version: ctr-1.0.0--hfc679d8_0")
...
set_shell_function("btrim",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/btrim/btrim-1.0.0--hfc679d8_0.simg btrim $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/btrim/btrim-1.0.0--hfc679d8_0.simg btrim $*')
