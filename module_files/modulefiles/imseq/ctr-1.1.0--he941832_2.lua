local help_message = [[
This is a module file for the container quay.io/biocontainers/imseq:1.1.0--he941832_2, which exposes the
following programs:
...
whatis("Name: imseq")
whatis("Version: ctr-1.1.0--he941832_2")
...
set_shell_function("imseq",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/imseq/imseq-1.1.0--he941832_2.simg imseq $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/imseq/imseq-1.1.0--he941832_2.simg imseq $*')
