local help_message = [[
This is a module file for the container quay.io/biocontainers/imseq:1.1.0--0, which exposes the
following programs:
...
set_shell_function("imseq",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/imseq/imseq-1.1.0--0.simg imseq $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/imseq/imseq-1.1.0--0.simg imseq $*')
