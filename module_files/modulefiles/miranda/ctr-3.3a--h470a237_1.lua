local help_message = [[
This is a module file for the container quay.io/biocontainers/miranda:3.3a--h470a237_1, which exposes the
following programs:
...
whatis("Name: miranda")
whatis("Version: ctr-3.3a--h470a237_1")
...
set_shell_function("miranda",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/miranda/miranda-3.3a--h470a237_1.simg miranda $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/miranda/miranda-3.3a--h470a237_1.simg miranda $*')
