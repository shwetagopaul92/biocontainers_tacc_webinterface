local help_message = [[
This is a module file for the container biocontainers/denovogui:v1.5.2_cv3, which exposes the
following programs:
...
set_shell_function("denovogui",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/denovogui/denovogui-v1.5.2_cv3.simg denovogui $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/denovogui/denovogui-v1.5.2_cv3.simg denovogui $*')
