local help_message = [[
This is a module file for the container biocontainers/denovogui:1.10.4, which exposes the
following programs:
...
set_shell_function("denovogui",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/denovogui/denovogui-1.10.4.simg denovogui $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/denovogui/denovogui-1.10.4.simg denovogui $*')
