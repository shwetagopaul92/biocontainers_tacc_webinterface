local help_message = [[
This is a module file for the container biocontainers/denovogui:v1.10.4_cv4, which exposes the
following programs:
...
whatis("Version: ctr-v1.10.4_cv4")
...
set_shell_function("denovogui",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/denovogui/denovogui-v1.10.4_cv4.simg denovogui $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/denovogui/denovogui-v1.10.4_cv4.simg denovogui $*')
