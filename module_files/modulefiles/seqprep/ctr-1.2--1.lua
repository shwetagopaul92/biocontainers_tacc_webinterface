local help_message = [[
This is a module file for the container quay.io/biocontainers/seqprep:1.2--1, which exposes the
following programs:
...
set_shell_function("SeqPrep",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/seqprep/seqprep-1.2--1.simg SeqPrep $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/seqprep/seqprep-1.2--1.simg SeqPrep $*')
