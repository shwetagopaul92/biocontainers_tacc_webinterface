local help_message = [[
This is a module file for the container quay.io/biocontainers/ngmlr:0.2.7--he941832_0, which exposes the
following programs:
...
whatis("Name: ngmlr")
whatis("Version: ctr-0.2.7--he941832_0")
...
set_shell_function("ngmlr",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/ngmlr/ngmlr-0.2.7--he941832_0.simg ngmlr $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/ngmlr/ngmlr-0.2.7--he941832_0.simg ngmlr $*')
