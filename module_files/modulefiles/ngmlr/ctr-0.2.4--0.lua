local help_message = [[
This is a module file for the container quay.io/biocontainers/ngmlr:0.2.4--0, which exposes the
following programs:
...
set_shell_function("ngmlr",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/ngmlr/ngmlr-0.2.4--0.simg ngmlr $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/ngmlr/ngmlr-0.2.4--0.simg ngmlr $*')
