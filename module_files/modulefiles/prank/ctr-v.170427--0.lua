local help_message = [[
This is a module file for the container quay.io/biocontainers/prank:v.170427--0, which exposes the
following programs:
...
set_shell_function("prank",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/prank/prank-v.170427--0.simg prank $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/prank/prank-v.170427--0.simg prank $*')
