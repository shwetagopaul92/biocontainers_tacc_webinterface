local help_message = [[
This is a module file for the container quay.io/biocontainers/sambamba:0.6.6--2, which exposes the
following programs:
...
set_shell_function("sambamba",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/sambamba/sambamba-0.6.6--2.simg sambamba $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/sambamba/sambamba-0.6.6--2.simg sambamba $*')
