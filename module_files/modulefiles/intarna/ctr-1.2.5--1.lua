local help_message = [[
This is a module file for the container quay.io/biocontainers/intarna:1.2.5--1, which exposes the
following programs:
...
set_shell_function("IntaRNA",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/intarna/intarna-1.2.5--1.simg IntaRNA $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/intarna/intarna-1.2.5--1.simg IntaRNA $*')
