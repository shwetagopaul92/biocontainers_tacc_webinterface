local help_message = [[
This is a module file for the container quay.io/biocontainers/genonets:1.1.6--py27_1, which exposes the
following programs:
...
whatis("Version: ctr-1.1.6--py27_1")
...
set_shell_function("fc-conflist",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/genonets/genonets-1.1.6--py27_1.simg fc-conflist $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/genonets/genonets-1.1.6--py27_1.simg fc-conflist $*')
set_shell_function("igraph",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/genonets/genonets-1.1.6--py27_1.simg igraph $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/genonets/genonets-1.1.6--py27_1.simg igraph $*')
