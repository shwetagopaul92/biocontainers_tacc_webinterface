local help_message = [[
This is a module file for the container quay.io/biocontainers/genonets:1.1.6--py27_0, which exposes the
following programs:
...
whatis("Version: ctr-1.1.6--py27_0")
...
set_shell_function("igraph",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/genonets/genonets-1.1.6--py27_0.simg igraph $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/genonets/genonets-1.1.6--py27_0.simg igraph $*')
