local help_message = [[
This is a module file for the container quay.io/biocontainers/genonets:1.1.6--py36_0, which exposes the
following programs:
...
set_shell_function("easy_install-3.6",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/genonets/genonets-1.1.6--py36_0.simg easy_install-3.6 $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/genonets/genonets-1.1.6--py36_0.simg easy_install-3.6 $*')
set_shell_function("igraph",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/genonets/genonets-1.1.6--py36_0.simg igraph $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/genonets/genonets-1.1.6--py36_0.simg igraph $*')
