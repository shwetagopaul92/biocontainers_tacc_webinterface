local help_message = [[
This is a module file for the container biocontainers/peptideprophet:v201510131012_cv1, which exposes the
following programs:
...
whatis("Version: ctr-v201510131012_cv1")
...
set_shell_function("PeptideProphet",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/peptideprophet/peptideprophet-v201510131012_cv1.simg PeptideProphet $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/peptideprophet/peptideprophet-v201510131012_cv1.simg PeptideProphet $*')
