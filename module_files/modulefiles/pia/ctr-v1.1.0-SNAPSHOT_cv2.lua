local help_message = [[
This is a module file for the container biocontainers/pia:v1.1.0-SNAPSHOT_cv2, which exposes the
following programs:
...
whatis("Name: pia")
whatis("Version: ctr-v1.1.0-SNAPSHOT_cv2")
...
set_shell_function("runpia.sh",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/pia/pia-v1.1.0-SNAPSHOT_cv2.simg runpia.sh $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/pia/pia-v1.1.0-SNAPSHOT_cv2.simg runpia.sh $*')
