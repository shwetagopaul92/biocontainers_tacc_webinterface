local help_message = [[
This is a module file for the container quay.io/biocontainers/genesplicer:1.0--1, which exposes the
following programs:
...
set_shell_function(".genesplicer-post-link.sh",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/genesplicer/genesplicer-1.0--1.simg .genesplicer-post-link.sh $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/genesplicer/genesplicer-1.0--1.simg .genesplicer-post-link.sh $*')
set_shell_function("genesplicer",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/genesplicer/genesplicer-1.0--1.simg genesplicer $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/genesplicer/genesplicer-1.0--1.simg genesplicer $*')
