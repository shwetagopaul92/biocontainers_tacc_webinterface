local help_message = [[
This is a module file for the container quay.io/biocontainers/allegro:2--0, which exposes the
following programs:
...
set_shell_function("allegro",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/allegro/allegro-2--0.simg allegro $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/allegro/allegro-2--0.simg allegro $*')
