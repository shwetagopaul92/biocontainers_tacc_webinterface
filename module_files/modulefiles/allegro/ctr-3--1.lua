local help_message = [[
This is a module file for the container quay.io/biocontainers/allegro:3--1, which exposes the
following programs:
...
set_shell_function("allegro",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/allegro/allegro-3--1.simg allegro $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/allegro/allegro-3--1.simg allegro $*')
