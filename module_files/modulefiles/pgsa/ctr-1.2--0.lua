local help_message = [[
This is a module file for the container quay.io/biocontainers/pgsa:1.2--0, which exposes the
following programs:
...
set_shell_function("PgSAgen",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/pgsa/pgsa-1.2--0.simg PgSAgen $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/pgsa/pgsa-1.2--0.simg PgSAgen $*')
set_shell_function("PgSAtest",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/pgsa/pgsa-1.2--0.simg PgSAtest $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/pgsa/pgsa-1.2--0.simg PgSAtest $*')
