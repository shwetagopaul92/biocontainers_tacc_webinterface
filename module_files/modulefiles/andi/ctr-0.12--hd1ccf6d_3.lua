local help_message = [[
This is a module file for the container quay.io/biocontainers/andi:0.12--hd1ccf6d_3, which exposes the
following programs:
...
whatis("Name: andi")
whatis("Version: ctr-0.12--hd1ccf6d_3")
...
set_shell_function("andi",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/andi/andi-0.12--hd1ccf6d_3.simg andi $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/andi/andi-0.12--hd1ccf6d_3.simg andi $*')
