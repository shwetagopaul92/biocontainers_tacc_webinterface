local help_message = [[
This is a module file for the container quay.io/biocontainers/andi:0.11--0, which exposes the
following programs:
...
set_shell_function("andi",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/andi/andi-0.11--0.simg andi $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/andi/andi-0.11--0.simg andi $*')
