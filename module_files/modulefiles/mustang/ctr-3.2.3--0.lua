local help_message = [[
This is a module file for the container quay.io/biocontainers/mustang:3.2.3--0, which exposes the
following programs:
...
set_shell_function("mustang",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/mustang/mustang-3.2.3--0.simg mustang $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/mustang/mustang-3.2.3--0.simg mustang $*')
