local help_message = [[
This is a module file for the container quay.io/biocontainers/motus:1.0--0, which exposes the
following programs:
...
set_shell_function("mOTUs.pl",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/motus/motus-1.0--0.simg mOTUs.pl $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/motus/motus-1.0--0.simg mOTUs.pl $*')
set_shell_function("perl5.22.0",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/motus/motus-1.0--0.simg perl5.22.0 $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/motus/motus-1.0--0.simg perl5.22.0 $*')
