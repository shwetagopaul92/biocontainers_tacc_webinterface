local help_message = [[
This is a module file for the container quay.io/biocontainers/dialign-tx:1.0.2--0, which exposes the
following programs:
...
set_shell_function("dialign-tx",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/dialign-tx/dialign-tx-1.0.2--0.simg dialign-tx $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/dialign-tx/dialign-tx-1.0.2--0.simg dialign-tx $*')
