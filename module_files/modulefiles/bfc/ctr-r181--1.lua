local help_message = [[
This is a module file for the container quay.io/biocontainers/bfc:r181--1, which exposes the
following programs:
...
set_shell_function("bfc",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/bfc/bfc-r181--1.simg bfc $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/bfc/bfc-r181--1.simg bfc $*')
