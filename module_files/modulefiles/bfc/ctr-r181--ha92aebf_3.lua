local help_message = [[
This is a module file for the container quay.io/biocontainers/bfc:r181--ha92aebf_3, which exposes the
following programs:
...
whatis("Name: bfc")
whatis("Version: ctr-r181--ha92aebf_3")
...
set_shell_function("bfc",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/bfc/bfc-r181--ha92aebf_3.simg bfc $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/bfc/bfc-r181--ha92aebf_3.simg bfc $*')
