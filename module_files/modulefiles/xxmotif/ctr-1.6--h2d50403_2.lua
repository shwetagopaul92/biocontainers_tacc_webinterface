local help_message = [[
This is a module file for the container quay.io/biocontainers/xxmotif:1.6--h2d50403_2, which exposes the
following programs:
...
whatis("Name: xxmotif")
whatis("Version: ctr-1.6--h2d50403_2")
...
set_shell_function("XXmotif",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/xxmotif/xxmotif-1.6--h2d50403_2.simg XXmotif $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/xxmotif/xxmotif-1.6--h2d50403_2.simg XXmotif $*')
