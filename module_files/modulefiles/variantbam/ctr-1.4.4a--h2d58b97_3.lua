local help_message = [[
This is a module file for the container quay.io/biocontainers/variantbam:1.4.4a--h2d58b97_3, which exposes the
following programs:
...
whatis("Version: ctr-1.4.4a--h2d58b97_3")
...
set_shell_function("variant",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/variantbam/variantbam-1.4.4a--h2d58b97_3.simg variant $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/variantbam/variantbam-1.4.4a--h2d58b97_3.simg variant $*')
