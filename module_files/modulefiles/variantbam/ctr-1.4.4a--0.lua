local help_message = [[
This is a module file for the container quay.io/biocontainers/variantbam:1.4.4a--0, which exposes the
following programs:
...
set_shell_function("variant",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/variantbam/variantbam-1.4.4a--0.simg variant $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/variantbam/variantbam-1.4.4a--0.simg variant $*')
