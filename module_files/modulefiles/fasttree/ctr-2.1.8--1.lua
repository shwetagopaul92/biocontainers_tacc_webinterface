local help_message = [[
This is a module file for the container quay.io/biocontainers/fasttree:2.1.8--1, which exposes the
following programs:
...
set_shell_function("FastTree",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/fasttree/fasttree-2.1.8--1.simg FastTree $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/fasttree/fasttree-2.1.8--1.simg FastTree $*')
