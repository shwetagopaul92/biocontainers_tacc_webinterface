local help_message = [[
This is a module file for the container biocontainers/zorro:v1.0.0_cv2, which exposes the
following programs:
...
set_shell_function("FastTree",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/zorro/zorro-v1.0.0_cv2.simg FastTree $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/zorro/zorro-v1.0.0_cv2.simg FastTree $*')
set_shell_function("zorro",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/zorro/zorro-v1.0.0_cv2.simg zorro $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/zorro/zorro-v1.0.0_cv2.simg zorro $*')
