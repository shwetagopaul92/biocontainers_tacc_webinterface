local help_message = [[
This is a module file for the container quay.io/biocontainers/paladin:1.3.1--0, which exposes the
following programs:
...
set_shell_function("paladin",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/paladin/paladin-1.3.1--0.simg paladin $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/paladin/paladin-1.3.1--0.simg paladin $*')
