local help_message = [[
This is a module file for the container quay.io/biocontainers/vcftools:0.1.16--he941832_2, which exposes the
following programs:
...
whatis("Version: ctr-0.1.16--he941832_2")
...
set_shell_function("vcftools",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/vcftools/vcftools-0.1.16--he941832_2.simg vcftools $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/vcftools/vcftools-0.1.16--he941832_2.simg vcftools $*')
