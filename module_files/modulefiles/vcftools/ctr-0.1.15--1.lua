local help_message = [[
This is a module file for the container quay.io/biocontainers/vcftools:0.1.15--1, which exposes the
following programs:
...
set_shell_function("vcftools",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/vcftools/vcftools-0.1.15--1.simg vcftools $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/vcftools/vcftools-0.1.15--1.simg vcftools $*')
