local help_message = [[
This is a module file for the container quay.io/biocontainers/pear:0.9.6--3, which exposes the
following programs:
...
set_shell_function("pear",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/pear/pear-0.9.6--3.simg pear $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/pear/pear-0.9.6--3.simg pear $*')
set_shell_function("pearRM",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/pear/pear-0.9.6--3.simg pearRM $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/pear/pear-0.9.6--3.simg pearRM $*')
