local help_message = [[
This is a module file for the container quay.io/biocontainers/swalign:0.3.3--py27_0, which exposes the
following programs:
...
set_shell_function("swalign",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/swalign/swalign-0.3.3--py27_0.simg swalign $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/swalign/swalign-0.3.3--py27_0.simg swalign $*')
