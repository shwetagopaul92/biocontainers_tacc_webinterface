local help_message = [[
This is a module file for the container quay.io/biocontainers/manta:1.3.0--py27_0, which exposes the
following programs:
...
set_shell_function("configManta.py",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/manta/manta-1.3.0--py27_0.simg configManta.py $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/manta/manta-1.3.0--py27_0.simg configManta.py $*')
