local help_message = [[
This is a module file for the container quay.io/biocontainers/manta:1.4.0--py27_1, which exposes the
following programs:
...
whatis("Name: manta")
whatis("Version: ctr-1.4.0--py27_1")
...
set_shell_function("configManta.py",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/manta/manta-1.4.0--py27_1.simg configManta.py $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/manta/manta-1.4.0--py27_1.simg configManta.py $*')
