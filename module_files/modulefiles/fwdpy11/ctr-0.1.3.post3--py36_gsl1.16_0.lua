local help_message = [[
This is a module file for the container quay.io/biocontainers/fwdpy11:0.1.3.post3--py36_gsl1.16_0, which exposes the
following programs:
...
whatis("Name: fwdpy11")
whatis("Version: ctr-0.1.3.post3--py36_gsl1.16_0")
