local help_message = [[
This is a module file for the container quay.io/biocontainers/verifybamid:1.1.3--1, which exposes the
following programs:
...
set_shell_function("verifyBamID",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/verifybamid/verifybamid-1.1.3--1.simg verifyBamID $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/verifybamid/verifybamid-1.1.3--1.simg verifyBamID $*')
