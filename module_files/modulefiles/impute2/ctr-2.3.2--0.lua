local help_message = [[
This is a module file for the container quay.io/biocontainers/impute2:2.3.2--0, which exposes the
following programs:
...
set_shell_function("impute2",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/impute2/impute2-2.3.2--0.simg impute2 $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/impute2/impute2-2.3.2--0.simg impute2 $*')
