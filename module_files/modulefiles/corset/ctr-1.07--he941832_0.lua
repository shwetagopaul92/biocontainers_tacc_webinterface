local help_message = [[
This is a module file for the container quay.io/biocontainers/corset:1.07--he941832_0, which exposes the
following programs:
...
whatis("Name: corset")
whatis("Version: ctr-1.07--he941832_0")
...
set_shell_function("corset",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/corset/corset-1.07--he941832_0.simg corset $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/corset/corset-1.07--he941832_0.simg corset $*')
set_shell_function("corset_fasta_ID_changer",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/corset/corset-1.07--he941832_0.simg corset_fasta_ID_changer $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/corset/corset-1.07--he941832_0.simg corset_fasta_ID_changer $*')
