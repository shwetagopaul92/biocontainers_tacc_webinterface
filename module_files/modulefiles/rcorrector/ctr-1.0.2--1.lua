local help_message = [[
This is a module file for the container quay.io/biocontainers/rcorrector:1.0.2--1, which exposes the
following programs:
...
set_shell_function("jellyfish",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/rcorrector/rcorrector-1.0.2--1.simg jellyfish $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/rcorrector/rcorrector-1.0.2--1.simg jellyfish $*')
set_shell_function("rcorrector",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/rcorrector/rcorrector-1.0.2--1.simg rcorrector $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/rcorrector/rcorrector-1.0.2--1.simg rcorrector $*')
