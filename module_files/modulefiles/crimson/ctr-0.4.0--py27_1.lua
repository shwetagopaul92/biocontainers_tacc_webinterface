local help_message = [[
This is a module file for the container quay.io/biocontainers/crimson:0.4.0--py27_1, which exposes the
following programs:
...
set_shell_function("crimson",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/crimson/crimson-0.4.0--py27_1.simg crimson $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/crimson/crimson-0.4.0--py27_1.simg crimson $*')
