local help_message = [[
This is a module file for the container quay.io/biocontainers/mosdepth:0.1.1--0, which exposes the
following programs:
...
set_shell_function("ksu",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/mosdepth/mosdepth-0.1.1--0.simg ksu $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/mosdepth/mosdepth-0.1.1--0.simg ksu $*')
