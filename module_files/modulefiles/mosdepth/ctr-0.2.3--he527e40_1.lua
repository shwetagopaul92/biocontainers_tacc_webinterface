local help_message = [[
This is a module file for the container quay.io/biocontainers/mosdepth:0.2.3--he527e40_1, which exposes the
following programs:
...
whatis("Version: ctr-0.2.3--he527e40_1")
...
set_shell_function("mosdepth",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/mosdepth/mosdepth-0.2.3--he527e40_1.simg mosdepth $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/mosdepth/mosdepth-0.2.3--he527e40_1.simg mosdepth $*')
