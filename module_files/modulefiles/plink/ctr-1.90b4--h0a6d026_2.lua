local help_message = [[
This is a module file for the container quay.io/biocontainers/plink:1.90b4--h0a6d026_2, which exposes the
following programs:
...
whatis("Name: plink")
whatis("Version: ctr-1.90b4--h0a6d026_2")
...
set_shell_function("plink",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/plink/plink-1.90b4--h0a6d026_2.simg plink $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/plink/plink-1.90b4--h0a6d026_2.simg plink $*')
