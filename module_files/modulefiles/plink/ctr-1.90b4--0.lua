local help_message = [[
This is a module file for the container quay.io/biocontainers/plink:1.90b4--0, which exposes the
following programs:
...
set_shell_function("plink",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/plink/plink-1.90b4--0.simg plink $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/plink/plink-1.90b4--0.simg plink $*')
