local help_message = [[
This is a module file for the container quay.io/biocontainers/peakzilla:1.0--py27_1, which exposes the
following programs:
...
set_shell_function("peakzilla.py",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/peakzilla/peakzilla-1.0--py27_1.simg peakzilla.py $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/peakzilla/peakzilla-1.0--py27_1.simg peakzilla.py $*')
