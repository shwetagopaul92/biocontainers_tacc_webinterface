local help_message = [[
This is a module file for the container quay.io/biocontainers/bayescan:2.0.1--h2d50403_1, which exposes the
following programs:
...
whatis("Version: ctr-2.0.1--h2d50403_1")
...
set_shell_function("bayescan2",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/bayescan/bayescan-2.0.1--h2d50403_1.simg bayescan2 $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/bayescan/bayescan-2.0.1--h2d50403_1.simg bayescan2 $*')
