local help_message = [[
This is a module file for the container quay.io/biocontainers/raxml:7.3.0--0, which exposes the
following programs:
...
set_shell_function("raxmlHPC-PTHREADS",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/raxml/raxml-7.3.0--0.simg raxmlHPC-PTHREADS $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/raxml/raxml-7.3.0--0.simg raxmlHPC-PTHREADS $*')
