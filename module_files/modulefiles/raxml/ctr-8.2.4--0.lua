local help_message = [[
This is a module file for the container quay.io/biocontainers/raxml:8.2.4--0, which exposes the
following programs:
...
set_shell_function("raxmlHPC-PTHREADS",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/raxml/raxml-8.2.4--0.simg raxmlHPC-PTHREADS $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/raxml/raxml-8.2.4--0.simg raxmlHPC-PTHREADS $*')
