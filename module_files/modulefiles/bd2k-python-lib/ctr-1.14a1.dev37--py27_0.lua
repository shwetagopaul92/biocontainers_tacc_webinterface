local help_message = [[
This is a module file for the container quay.io/biocontainers/bd2k-python-lib:1.14a1.dev37--py27_0, which exposes the
following programs:
...
whatis("Version: ctr-1.14a1.dev37--py27_0")
