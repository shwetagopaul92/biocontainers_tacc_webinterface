local help_message = [[
This is a module file for the container quay.io/biocontainers/drive:0.3.9--1, which exposes the
following programs:
...
set_shell_function("drive",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/drive/drive-0.3.9--1.simg drive $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/drive/drive-0.3.9--1.simg drive $*')
