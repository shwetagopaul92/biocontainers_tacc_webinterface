local help_message = [[
This is a module file for the container quay.io/biocontainers/ghostz:1.0.0--0, which exposes the
following programs:
...
set_shell_function("ghostz",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/ghostz/ghostz-1.0.0--0.simg ghostz $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/ghostz/ghostz-1.0.0--0.simg ghostz $*')
