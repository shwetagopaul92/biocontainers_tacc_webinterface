local help_message = [[
This is a module file for the container quay.io/biocontainers/intermine:1.09.09--py36_0, which exposes the
following programs:
...
whatis("Version: ctr-1.09.09--py36_0")
...
set_shell_function("easy_install-3.6",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/intermine/intermine-1.09.09--py36_0.simg easy_install-3.6 $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/intermine/intermine-1.09.09--py36_0.simg easy_install-3.6 $*')
