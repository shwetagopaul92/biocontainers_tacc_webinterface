local help_message = [[
This is a module file for the container quay.io/biocontainers/intermine:1.10.0--py27_0, which exposes the
following programs:
...
whatis("Version: ctr-1.10.0--py27_0")
...
set_shell_function("xslt-config",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/intermine/intermine-1.10.0--py27_0.simg xslt-config $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/intermine/intermine-1.10.0--py27_0.simg xslt-config $*')
set_shell_function("xsltproc",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/intermine/intermine-1.10.0--py27_0.simg xsltproc $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/intermine/intermine-1.10.0--py27_0.simg xsltproc $*')
