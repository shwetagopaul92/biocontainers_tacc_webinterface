local help_message = [[
This is a module file for the container quay.io/biocontainers/intermine:1.10.0--py_2, which exposes the
following programs:
...
whatis("Version: ctr-1.10.0--py_2")
...
set_shell_function("xslt-config",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/intermine/intermine-1.10.0--py_2.simg xslt-config $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/intermine/intermine-1.10.0--py_2.simg xslt-config $*')
set_shell_function("xsltproc",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/intermine/intermine-1.10.0--py_2.simg xsltproc $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/intermine/intermine-1.10.0--py_2.simg xsltproc $*')
