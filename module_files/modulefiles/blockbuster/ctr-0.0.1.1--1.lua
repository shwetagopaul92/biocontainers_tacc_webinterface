local help_message = [[
This is a module file for the container quay.io/biocontainers/blockbuster:0.0.1.1--1, which exposes the
following programs:
...
set_shell_function("blockbuster.x",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/blockbuster/blockbuster-0.0.1.1--1.simg blockbuster.x $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/blockbuster/blockbuster-0.0.1.1--1.simg blockbuster.x $*')
