local help_message = [[
This is a module file for the container biocontainers/peptideshaker:v1.16.17_cv1, which exposes the
following programs:
...
whatis("Version: ctr-v1.16.17_cv1")
...
set_shell_function("PeptideShaker",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/peptideshaker/peptideshaker-v1.16.17_cv1.simg PeptideShaker $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/peptideshaker/peptideshaker-v1.16.17_cv1.simg PeptideShaker $*')
