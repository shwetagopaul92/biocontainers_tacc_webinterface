local help_message = [[
This is a module file for the container biocontainers/peptideshaker:v1.16.16_cv2, which exposes the
following programs:
...
whatis("Version: ctr-v1.16.16_cv2")
...
set_shell_function("PeptideShaker",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/peptideshaker/peptideshaker-v1.16.16_cv2.simg PeptideShaker $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/peptideshaker/peptideshaker-v1.16.16_cv2.simg PeptideShaker $*')
