local help_message = [[
This is a module file for the container quay.io/biocontainers/rnasnp:1.2--h470a237_4, which exposes the
following programs:
...
whatis("Name: rnasnp")
whatis("Version: ctr-1.2--h470a237_4")
...
set_shell_function("RNAsnp",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/rnasnp/rnasnp-1.2--h470a237_4.simg RNAsnp $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/rnasnp/rnasnp-1.2--h470a237_4.simg RNAsnp $*')
