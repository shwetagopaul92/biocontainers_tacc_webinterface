local help_message = [[
This is a module file for the container quay.io/biocontainers/rnasnp:1.2--0, which exposes the
following programs:
...
set_shell_function("RNAsnp",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/rnasnp/rnasnp-1.2--0.simg RNAsnp $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/rnasnp/rnasnp-1.2--0.simg RNAsnp $*')
