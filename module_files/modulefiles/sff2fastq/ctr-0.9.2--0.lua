local help_message = [[
This is a module file for the container quay.io/biocontainers/sff2fastq:0.9.2--0, which exposes the
following programs:
...
set_shell_function("sff2fastq",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/sff2fastq/sff2fastq-0.9.2--0.simg sff2fastq $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/sff2fastq/sff2fastq-0.9.2--0.simg sff2fastq $*')
