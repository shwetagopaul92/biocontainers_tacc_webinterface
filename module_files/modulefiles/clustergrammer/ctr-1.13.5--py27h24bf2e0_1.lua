local help_message = [[
This is a module file for the container quay.io/biocontainers/clustergrammer:1.13.5--py27h24bf2e0_1, which exposes the
following programs:
...
whatis("Version: ctr-1.13.5--py27h24bf2e0_1")
