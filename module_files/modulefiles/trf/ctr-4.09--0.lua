local help_message = [[
This is a module file for the container quay.io/biocontainers/trf:4.09--0, which exposes the
following programs:
...
set_shell_function("trf",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/trf/trf-4.09--0.simg trf $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/trf/trf-4.09--0.simg trf $*')
