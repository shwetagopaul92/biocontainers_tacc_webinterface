local help_message = [[
This is a module file for the container quay.io/biocontainers/splitmem:1.0--0, which exposes the
following programs:
...
set_shell_function("splitMEM",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/splitmem/splitmem-1.0--0.simg splitMEM $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/splitmem/splitmem-1.0--0.simg splitMEM $*')
