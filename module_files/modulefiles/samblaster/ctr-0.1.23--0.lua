local help_message = [[
This is a module file for the container quay.io/biocontainers/samblaster:0.1.23--0, which exposes the
following programs:
...
set_shell_function("samblaster",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/samblaster/samblaster-0.1.23--0.simg samblaster $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/samblaster/samblaster-0.1.23--0.simg samblaster $*')
