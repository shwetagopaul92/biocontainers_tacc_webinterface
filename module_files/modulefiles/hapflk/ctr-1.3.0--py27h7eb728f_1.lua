local help_message = [[
This is a module file for the container quay.io/biocontainers/hapflk:1.3.0--py27h7eb728f_1, which exposes the
following programs:
...
whatis("Name: hapflk")
whatis("Version: ctr-1.3.0--py27h7eb728f_1")
...
set_shell_function("hapflk",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/hapflk/hapflk-1.3.0--py27h7eb728f_1.simg hapflk $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/hapflk/hapflk-1.3.0--py27h7eb728f_1.simg hapflk $*')
