local help_message = [[
This is a module file for the container biocontainers/jbrowse:v1.11.6_cv2, which exposes the
following programs:
...
This container was pulled from:
	...
	https://hub.docker.com/r/biocontainers/jbrowse
...
whatis("Name: jbrowse")
whatis("Version: ctr-v1.11.6_cv2")
...
whatis("URL: https://hub.docker.com/r/biocontainers/jbrowse")
