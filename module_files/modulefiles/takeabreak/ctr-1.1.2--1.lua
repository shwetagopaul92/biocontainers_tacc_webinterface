local help_message = [[
This is a module file for the container quay.io/biocontainers/takeabreak:1.1.2--1, which exposes the
following programs:
...
set_shell_function("TakeABreak",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/takeabreak/takeabreak-1.1.2--1.simg TakeABreak $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/takeabreak/takeabreak-1.1.2--1.simg TakeABreak $*')
