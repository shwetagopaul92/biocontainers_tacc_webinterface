local help_message = [[
This is a module file for the container quay.io/biocontainers/takeabreak:1.1.2--hd28b015_2, which exposes the
following programs:
...
whatis("Version: ctr-1.1.2--hd28b015_2")
...
set_shell_function("TakeABreak",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/takeabreak/takeabreak-1.1.2--hd28b015_2.simg TakeABreak $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/takeabreak/takeabreak-1.1.2--hd28b015_2.simg TakeABreak $*')
