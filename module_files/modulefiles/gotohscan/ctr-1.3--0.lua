local help_message = [[
This is a module file for the container quay.io/biocontainers/gotohscan:1.3--0, which exposes the
following programs:
...
set_shell_function("GotohScan",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/gotohscan/gotohscan-1.3--0.simg GotohScan $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/gotohscan/gotohscan-1.3--0.simg GotohScan $*')
