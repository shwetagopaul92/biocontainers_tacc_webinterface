local help_message = [[
This is a module file for the container quay.io/biocontainers/muscle:3.8.1551--2, which exposes the
following programs:
...
set_shell_function("muscle",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/muscle/muscle-3.8.1551--2.simg muscle $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/muscle/muscle-3.8.1551--2.simg muscle $*')
