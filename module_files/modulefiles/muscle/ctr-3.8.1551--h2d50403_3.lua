local help_message = [[
This is a module file for the container quay.io/biocontainers/muscle:3.8.1551--h2d50403_3, which exposes the
following programs:
...
whatis("Name: muscle")
whatis("Version: ctr-3.8.1551--h2d50403_3")
...
set_shell_function("muscle",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/muscle/muscle-3.8.1551--h2d50403_3.simg muscle $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/muscle/muscle-3.8.1551--h2d50403_3.simg muscle $*')
