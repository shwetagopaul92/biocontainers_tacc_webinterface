local help_message = [[
This is a module file for the container biocontainers/novor:v1b_cv3, which exposes the
following programs:
...
set_shell_function("novor",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/novor/novor-v1b_cv3.simg novor $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/novor/novor-v1b_cv3.simg novor $*')
