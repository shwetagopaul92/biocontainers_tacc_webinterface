local help_message = [[
This is a module file for the container biocontainers/novor:1b, which exposes the
following programs:
...
set_shell_function("novor",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/novor/novor-1b.simg novor $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/novor/novor-1b.simg novor $*')
