local help_message = [[
This is a module file for the container quay.io/biocontainers/migraine:0.5.2--0, which exposes the
following programs:
...
set_shell_function("migraine",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/migraine/migraine-0.5.2--0.simg migraine $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/migraine/migraine-0.5.2--0.simg migraine $*')
