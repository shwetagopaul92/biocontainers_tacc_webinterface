local help_message = [[
This is a module file for the container quay.io/biocontainers/sailfish:0.10.1--boost1.64_2, which exposes the
following programs:
...
whatis("Version: ctr-0.10.1--boost1.64_2")
...
set_shell_function("sailfish",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/sailfish/sailfish-0.10.1--boost1.64_2.simg sailfish $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/sailfish/sailfish-0.10.1--boost1.64_2.simg sailfish $*')
