local help_message = [[
This is a module file for the container quay.io/biocontainers/trinculo:0.96--0, which exposes the
following programs:
...
set_shell_function("trinculo",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/trinculo/trinculo-0.96--0.simg trinculo $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/trinculo/trinculo-0.96--0.simg trinculo $*')
