local help_message = [[
This is a module file for the container quay.io/biocontainers/seqtk:r93--0, which exposes the
following programs:
...
set_shell_function("seqtk",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/seqtk/seqtk-r93--0.simg seqtk $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/seqtk/seqtk-r93--0.simg seqtk $*')
