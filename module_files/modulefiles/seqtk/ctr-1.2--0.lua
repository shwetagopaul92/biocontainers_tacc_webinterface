local help_message = [[
This is a module file for the container quay.io/biocontainers/seqtk:1.2--0, which exposes the
following programs:
...
set_shell_function("seqtk",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/seqtk/seqtk-1.2--0.simg seqtk $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/seqtk/seqtk-1.2--0.simg seqtk $*')
