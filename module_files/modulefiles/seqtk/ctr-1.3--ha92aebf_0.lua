local help_message = [[
This is a module file for the container quay.io/biocontainers/seqtk:1.3--ha92aebf_0, which exposes the
following programs:
...
whatis("Name: seqtk")
whatis("Version: ctr-1.3--ha92aebf_0")
...
set_shell_function("seqtk",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/seqtk/seqtk-1.3--ha92aebf_0.simg seqtk $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/seqtk/seqtk-1.3--ha92aebf_0.simg seqtk $*')
