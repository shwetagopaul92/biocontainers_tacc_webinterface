local help_message = [[
This is a module file for the container quay.io/biocontainers/rapmap:v0.2.1--hfc679d8_2, which exposes the
following programs:
...
whatis("Name: rapmap")
whatis("Version: ctr-v0.2.1--hfc679d8_2")
...
set_shell_function("rapmap",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/rapmap/rapmap-v0.2.1--hfc679d8_2.simg rapmap $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/rapmap/rapmap-v0.2.1--hfc679d8_2.simg rapmap $*')
