local help_message = [[
This is a module file for the container quay.io/biocontainers/tedna:1.2.2--1, which exposes the
following programs:
...
set_shell_function("tedna",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/tedna/tedna-1.2.2--1.simg tedna $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/tedna/tedna-1.2.2--1.simg tedna $*')
