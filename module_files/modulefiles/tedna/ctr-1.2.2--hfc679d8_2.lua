local help_message = [[
This is a module file for the container quay.io/biocontainers/tedna:1.2.2--hfc679d8_2, which exposes the
following programs:
...
whatis("Name: tedna")
whatis("Version: ctr-1.2.2--hfc679d8_2")
...
set_shell_function("tedna",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/tedna/tedna-1.2.2--hfc679d8_2.simg tedna $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/tedna/tedna-1.2.2--hfc679d8_2.simg tedna $*')
