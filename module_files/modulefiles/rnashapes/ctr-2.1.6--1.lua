local help_message = [[
This is a module file for the container quay.io/biocontainers/rnashapes:2.1.6--1, which exposes the
following programs:
...
set_shell_function("RNAshapes",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/rnashapes/rnashapes-2.1.6--1.simg RNAshapes $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/rnashapes/rnashapes-2.1.6--1.simg RNAshapes $*')
