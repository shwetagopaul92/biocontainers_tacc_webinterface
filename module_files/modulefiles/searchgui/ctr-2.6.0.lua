local help_message = [[
This is a module file for the container biocontainers/searchgui:2.6.0, which exposes the
following programs:
...
set_shell_function("SearchGUI",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/searchgui/searchgui-2.6.0.simg SearchGUI $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/searchgui/searchgui-2.6.0.simg SearchGUI $*')
