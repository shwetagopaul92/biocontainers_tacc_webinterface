local help_message = [[
This is a module file for the container biocontainers/searchgui:v2.6.0_cv2, which exposes the
following programs:
...
set_shell_function("SearchGUI",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/searchgui/searchgui-v2.6.0_cv2.simg SearchGUI $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/searchgui/searchgui-v2.6.0_cv2.simg SearchGUI $*')
