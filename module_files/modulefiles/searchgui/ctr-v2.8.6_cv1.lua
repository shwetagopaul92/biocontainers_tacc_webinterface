local help_message = [[
This is a module file for the container biocontainers/searchgui:v2.8.6_cv1, which exposes the
following programs:
...
set_shell_function("SearchGUI",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/searchgui/searchgui-v2.8.6_cv1.simg SearchGUI $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/searchgui/searchgui-v2.8.6_cv1.simg SearchGUI $*')
