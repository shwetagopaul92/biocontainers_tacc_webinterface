local help_message = [[
This is a module file for the container biocontainers/searchgui:2.8.6, which exposes the
following programs:
...
set_shell_function("SearchGUI",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/searchgui/searchgui-2.8.6.simg SearchGUI $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/searchgui/searchgui-2.8.6.simg SearchGUI $*')
