local help_message = [[
This is a module file for the container quay.io/biocontainers/bgt:r283--0, which exposes the
following programs:
...
set_shell_function("bgt",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/bgt/bgt-r283--0.simg bgt $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/bgt/bgt-r283--0.simg bgt $*')
