local help_message = [[
This is a module file for the container biocontainers/comet:v2016012_cv3, which exposes the
following programs:
...
whatis("Name: comet")
whatis("Version: ctr-v2016012_cv3")
...
set_shell_function("comet",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/comet/comet-v2016012_cv3.simg comet $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/comet/comet-v2016012_cv3.simg comet $*')
