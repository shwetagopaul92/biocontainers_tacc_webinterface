local help_message = [[
This is a module file for the container biocontainers/comet:2016010, which exposes the
following programs:
...
set_shell_function("comet",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/comet/comet-2016010.simg comet $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/comet/comet-2016010.simg comet $*')
