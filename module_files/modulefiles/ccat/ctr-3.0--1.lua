local help_message = [[
This is a module file for the container quay.io/biocontainers/ccat:3.0--1, which exposes the
following programs:
...
set_shell_function("CCAT",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/ccat/ccat-3.0--1.simg CCAT $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/ccat/ccat-3.0--1.simg CCAT $*')
